...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', "gemini-1.5-pro")
        self.fast_token_limit = int(os.getenv('FAST_TOKEN_LIMIT', 1000000))
        self.smart_token_limit = int(os.getenv('SMART_TOKEN_LIMIT', 1000000))
