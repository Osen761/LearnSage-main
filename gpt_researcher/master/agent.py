...
class GPTResearcher:
    ...
    async def write_report(self, existing_headers=None):
        """
    ...
    async def __get_context_by_search(self, query, scraped_data=None):
        """
    ...
    async def __process_sub_query(self, sub_query: str, scraped_data=None):
    ...
    async def __get_similar_content_by_query(self, query, pages):
        ...
        # Run Tasks
        return context_compressor.get_context(query=query, max_results=8, )
